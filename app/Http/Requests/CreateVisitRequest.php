...
class CreateVisitRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'diagnosis.treatments'               => ['required_if:diagnosis.type,treatment', 'array'],
            'diagnosis.treatments.*.buccal_zone' => ['required_if:diagnosis.type,treatment', 'exists:buccal_zones,id'],
            'diagnosis.treatments.*.treatment'   => ['required_if:diagnosis.type,treatment', 'exists:treatments,id'],
            'indications'                        => ['array'],

...
class CDA extends _Model
{
    ...
    public function generateForMasterVisit(Visit $visit)
    {
        ...
        $progress = Progress::where(
            ...
            $treatments_assigned->map(function(TreatmentAssigned $t) { return $t->id; })
        )->get();
        
        $follow_up_visits = Visit::where('progress_id', $progress->map(function(Progress $p) { return $p->id; }))->get();
